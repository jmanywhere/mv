    ...
    <>
      <section className=" flex flex-col items-center bg-[url('/images/bg/night_sky_banner.png')] bg-cover bg-clip-border bg-right-top bg-no-repeat px-8 pb-32 bg-blend-normal md:rounded-br-[90px]">
        ...
        <h2 className=" text-center text-4xl text-white">
          Every <span className="text-primary">Moon</span> has to start
          Somewhere
        </h2>
      ...
      <section className=" flex w-full flex-col items-center pt-[64px] pb-[76px] lg:flex-row lg:items-start">
        ...
        <div>
          ...
          >
            ...
            Crowd Funding platform that allows projects to seamlessly raise
            funds, with or without having a token, allowing you the option of
            Crypto, or traditional non-crypto, crowdfunding and fundraising.
          </p>
          <p
            className=" 
                  mb-[41px]
          ...
          >
            ...
            royalty sharing fundraise to launch your non-crypto based video
            game, raising funds for your brick and mortar retail store, or just
            crowdfunding some relief to help pay for your cute little kitty
            cat&apos;s vet bill, Moon Vector has you covered. Easy to deploy,
            easy to set your terms and timeline, and easy to collect and
            distribute funds/tokens, Moon Vector removes the friction and
            headache from launching projects and jumping through hoops. Just set
            your terms, customize your page, and you&apos;re ready to go!
          </p>
          <div
            className="
                  flex
